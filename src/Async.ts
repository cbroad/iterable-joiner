...
export namespace Async {
    ...
    export abstract class Abstract<T> implements AsyncIterable<T> {
        ...
        async *[Symbol.asyncIterator](): AsyncIterator<T, any, undefined> {
            ...
            this.#iterables.forEach( startIterating );
        ...
        protected abstract _merge( state:IterableJoinerState<T> ): AsyncIterable<T>;
    ...
    export class Equitable<T> extends Abstract<T> {
        ...
        protected _merge( state:IterableJoinerState<T> ): AsyncIterable<T> {
